...
\begin{figure}[!thb]
    ...
    \end{center}
    \caption{Map of the limbic system. HC: Hippocampus, mPFC: medial prefrontal
  ...
  LH: lateral hypothalamus. \href{https://github.com/berndporr/limbic-system/blob/master/limbic-map.pdf}{Link to the full resolution PDF.}\label{linbic-map}}
\end{figure}
\end{latexonly}
